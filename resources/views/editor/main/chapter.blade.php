...
<body>
    ...
    <div class="container" style="margin-top:3%; margin-botttom:3%;">
        ...
        <!-- <div class="row"> -->
        <div class="" id="chapters_box" style="top: 10%; margin-top:50px; margin-bottom:50px; margin-right:19%; position:absolute; z-index:1">
                ...
                <span class="one" style="width:200px; height:350px;display:inline-block; margin-top:4%;margin-right:4%;">
                    ...
                    <span class="bottom" style="width:300px;height:80px;">
                        ...
                        <div class="button" style="margin-left:-6%">
                            <button type="button" style="cursor: pointer;border: none; background-color:transparent; height:25px; ">
                                <img src="{{asset('image/chapter_edit.png')}}" title="修正" style="text-align:center; height:100%; font-size:15px; background-color:transparent; color:#6c757d;"></button>
                            <button type="button" style="cursor: pointer;border: none; background-color:transparent; height:25px;">
                                <img src="{{asset('image/chapter_delete.png')}}" title="削除" style="text-align:center; height:100%; font-size:15px; background-color:transparent; color:#6c757d;"></button>
                            @if($cn->subsubtitle)
                            <button type="button" style="border: none; background-color:transparent;  height:25px;" id="push_alarm">
                                <a href="{{url('publication')}}/{{$row['num_of_work']}}/{{$row['num']}}">
                                    <img src="{{asset('image/archive.png')}}" title="発行" style="text-align:center;width:30px; height:100%; font-size:15px; background-color:transparent; color:#6c757d;">
                                </a>
                            </button>
                            @endif
                        </div>
