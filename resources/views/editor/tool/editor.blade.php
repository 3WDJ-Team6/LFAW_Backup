    ...
    <div class="area">
        ...
        <div class="title-bar">
            ...
            <form style="display: inline;margin-left:5%;" action="{{url('editor/main/list')}}/{{$content_of_works['num_of_chapter']}}">
                ...
                <a id="pre-btn" class="nav-btn" href="#preview" rel="modal:open" style="color:white;">プレビュー</a>
                {{--</span>--}}
...
<div class="ep-tem-area">
    <nav class="nav_left">
        ...
        <div class="ep">
            ...
            {{--<div class="ep-btns">
                    <div class="btn ep-btn" onclick="javascript:popupInEditor({{$content_of_works['num_of_chapter']}})">追加
        </div>
