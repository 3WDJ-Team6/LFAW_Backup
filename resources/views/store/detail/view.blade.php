    ...
    <div class="container_box" style="    overflow-y: hidden;">
        ...
        <div class="form-group left_group">
            ...
            <div class="main-form">
                <div class="main_image">
                    <img class="main_image_img" src="{{$product->url_of_illustration}}" onclick="openModal();currentDiv(1)">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group" style=" height:90px; cursor:pointer; margin-top:30px; margin-left:-10px;">
                    ...
                    <img src="{{$post->url_of_illustration}}" class="w3-hover-shadow" onclick="openModal();currentDiv(1)" style="width:70px; height:70px; margin:10px; display:inline-block;opacity: 0;">
                    @endforeach
                </div>
            </div>
        </div>
        ...
        <div class="form-group right_group">
            ...
            <div class="top_form">
                ...
                <span style="width:200px;margin-left:60%;">
