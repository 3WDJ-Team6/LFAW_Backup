...
class PublicationController extends Controller
{
    ...
    */
    public function publish($num_of_work, $num_of_chapter, request $request)
    {
        ...
        $token = 'czscRu_w_co:APA91bFJ6wwj_YRTDyeVaHKJViXNropFAqwluqGxEU2PEG3OSlLbwFNFMSkiueSu8llJwRvCzg9xsKZ5wcDlB7OBQ_RwZ5Zm9LcUZ4TYEuP9nzcyr0VbKxMSKi3HRRBGLCL5R996wH0S';

        $notification = [
            'title' => $work_title,
            'body' => $work_title . 'がアップデートされました。'
        ];
